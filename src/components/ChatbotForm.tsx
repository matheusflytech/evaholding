...
const questions = [
  { key: "nome", label: "Qual seu nome?", placeholder: "Seu nome completo", type: "text", maxLength: 100 },
  { key: "empresa", label: "Qual o nome da sua empresa?", placeholder: "Nome da empresa", type: "text", maxLength: 100 },
  { key: "nicho", label: "Qual seu nicho de atuação?", placeholder: "Ex: Clínica, Advocacia, Marketing...", type: "text", maxLength: 100 },
  { key: "desafio", label: "Qual seu maior desafio hoje?", placeholder: "Descreva brevemente", type: "text", maxLength: 500 },
  { key: "faturamento", label: "Qual seu faturamento mensal aproximado?", placeholder: "Ex: R$ 50.000", type: "text", maxLength: 50 },
  { key: "email", label: "Qual o seu e-mail?", placeholder: "seunome@empresa.com", type: "email", maxLength: 150 },
  { key: "telefone", label: "Qual o seu número de WhatsApp?", placeholder: "DDD + número (ex: 21999999999)", type: "tel", maxLength: 30 },
];
